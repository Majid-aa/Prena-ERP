...
export const ProfilePage: React.FC = () => {
  ...
  return (
    <div>
      <div className="mb-4">
        <h4 className="mb-1" style={{ fontWeight: 500 }}>👤 پروفایل کاربری</h4>
        ...
        <div className="col-12 col-lg-4">
          <div className="card p-4 text-center" style={{ borderRadius: '12px' }}>
            <div 
              ...
              style={{ width: 96, height: 96, background: 'linear-gradient(135deg, #1A237E, #7C4DFF)', fontSize: '2.5rem' }}
            >
          ...
          <div className="card p-4" style={{ borderRadius: '12px' }}>
            ...
            <div className="mb-3">
              <label className="form-label" style={{ fontSize: '0.85rem', color: '#555' }}>
                <RiUserLine className="ms-1" /> نام و نام خانوادگی
              </label>
            ...
            <div className="mb-3">
              <label className="form-label" style={{ fontSize: '0.85rem', color: '#555' }}>
                <RiPhoneLine className="ms-1" /> شماره موبایل
              </label>
            ...
            <div className="mb-4">
              <label className="form-label" style={{ fontSize: '0.85rem', color: '#555' }}>
                <RiMailLine className="ms-1" /> ایمیل (اختیاری)
              </label>
            ...
            <h6 className="mb-3" style={{ fontWeight: 500 }}>
              <RiShieldKeyholeLine className="ms-1" /> تغییر رمز عبور
            </h6>

            <div className="mb-3">
              <label className="form-label" style={{ fontSize: '0.85rem', color: '#555' }}>رمز عبور فعلی</label>
            ...
            <div className="mb-4">
              <label className="form-label" style={{ fontSize: '0.85rem', color: '#555' }}>رمز عبور جدید</label>
            ...
            <button 
              ...
              onClick={handleSave}
              style={{ background: saved ? '#00C853' : 'linear-gradient(135deg, #1A237E, #283593)', borderRadius: '8px', padding: '10px 24px', transition: 'all 0.3s' }}
            >
